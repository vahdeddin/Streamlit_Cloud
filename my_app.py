...
st.video("https://www.youtube.com/watch?v=pwFxWkFm_q8")

st.checkbox("Show/Hide")
cbox = st.checkbox("Hide/Seek")
if cbox:
    st.write("Showing")
else:
    st.write("Hiding")
...
option2 = st.slider("Select a number", max_value=30.2, value=5.2, step=0.2)   
option2 = st.slider("Select a number", step= 5)   
